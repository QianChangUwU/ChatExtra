...
create index if not exists user_channels_lodestone_id_idx on user_channels (lodestone_id);
create index if not exists user_channels_channel_id_idx on user_channels (channel_id);
...
create index if not exists channel_invites_channel_id_idx on channel_invites (channel_id);
create index if not exists channel_invites_channel_id_invited_idx on channel_invites (channel_id, invited);
